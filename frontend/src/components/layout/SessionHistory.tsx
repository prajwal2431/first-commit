                        ...
                        <div className="space-y-1">
                            {sessions.map(sess => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className="truncate flex-1 pr-6 flex items-center h-full text-xs">
                                            {editingSessionId === sess.id ? (
                                                <input
                                                    ...
                                                    autoFocus
                                                    className="w-full bg-white border border-gray-300 rounded-none px-1 py-0.5 text-xs outline-none text-black font-mono"
                                                />
                                            ) : (
                                                sess.query
                                            )}
                                        ...
                                        <div className={cn(
                                            ...
                                            {isMenuOpen && (
                                                <div className="absolute right-0 top-full mt-1 w-32 bg-white border border-gray-200 shadow-xl py-1 z-50 flex flex-col font-mono text-[10px] text-gray-700">
                                                    <button
                                                    ...
                                                    <button
                                                        ...
                                                        className="px-3 py-2 text-left hover:bg-red-50 text-red-600 flex items-center gap-2 border-t border-gray-100"
                                                    >
