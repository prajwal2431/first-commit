"""
Shared state schema for the Contextual Scout supervisor graph.
...
class ScoutGraphState(TypedDict, total=False):
    """State for the Contextual Scout supervisor graph. All list fields use reducers for parallel merge."""

    messages: Annotated[list[BaseMessage], _messages_reducer]
    external_signals: Annotated[list[dict[str, Any]], _list_reducer]
    marketplace_checks: Annotated[list[dict[str, Any]], _list_reducer]
    supply_chain_audits: Annotated[list[dict[str, Any]], _list_reducer]
    confidence_scores: Annotated[list[dict[str, Any]], _list_reducer]
    evidence_traces: Annotated[list[dict[str, Any]], _list_reducer]
